...
**Anders (09/23):**
- Tested iPhone AR stuff, got the scene and data
- Set up the websocket between the app and a locally hosted website
- Phone app hosts a server and then the web view inside the app connects to that server (everything is run on the phone)
